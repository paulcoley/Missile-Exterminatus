...
private:
    ...
    //////////////////////////////////////////////
public:
	Agent(Ogre::SceneManager* SceneManager, std::string name, std::string filename, float height, float scale, Grid* g);
	~Agent();
	void setPosition(float x, float y, float z);
	void setGridDestination(GridNode* node); //Set agent destination on the grid by passing a GridNode.
